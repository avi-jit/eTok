...
def main(
    ...
    if DATASET == 'shakespeare': # one line of poem is roughly 50 characters
        ...
        text = pickle.load(open('/scratch1/sghaneka/etok/roots_indic-ta_wiki.pkl','rb'))
    elif DATASET == 'indic-hi': # data has 16,666,528 characters, 1725 unique; 3137071 words, 209,167 unique. maxlen 185
        text = pickle.load(open('/scratch1/sghaneka/etok/roots_indic-hi_wiki.pkl','rb'))
    else:
    ...
    if not LOAD_CKPT:
        ...
        # scheduler
        lr_decay = LearningRateDecayCallback(learning_rate=learning_rate, warmup_tokens=512*20,
